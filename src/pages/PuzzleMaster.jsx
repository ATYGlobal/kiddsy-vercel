...
const CATEGORIES = [
  ...
  { id:"cities",    label:"Cities",    emoji:"1f3d9", color:C.blue,   icon:Building2, items:CITIES,    premium:true  }, // 🏙️
  { id:"nature",    label:"Nature",    emoji:"1f33f", color:"#2E7D32",icon:Leaf,       items:NATURE,    premium:true  }, // 🌿
  { id:"monuments", label:"Monuments", emoji:"1f3db", color:"#6D4C41",icon:Landmark,   items:MONUMENTS, premium:true  }, // 🏛️
];
