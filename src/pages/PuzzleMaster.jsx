...
const MONUMENTS = [
  ...
  { name:"Burj Khalifa",emoji:"🌆",color:"#00838F",img:u("burj khalifa dubai skyscraper"),
    fact:"The Burj Khalifa is so tall that you can watch the sunset from the top floor, then take an elevator down and watch it again!",
...
export default function PuzzleMaster({ lang:propLang, onLangChange }) {
  ...
  // Reset when item or size changes
          ...
          <div style={{ display:"flex", flexDirection:"column", gap:10 }}>
            ...
            <div>
              <div style={{
                ...
                background:(accent)+"18", marginBottom:6,
                fontFamily:"var(--font-body,'Nunito',sans-serif)",
